...
public class NameComparator implements Comparator<Member> {
    ...
    public void sortSwimmersByOneAttribute() {
        ...
        switch (userChoise) {
            ...
            case 2 -> Collections.sort(memberList, new comparator.AgeComparator());
    ...
    public void sortSwimmersByTwoAttributes(int userChoice1, int userChoice2) {
        ...
        switch (userChoice1) {
            ...
            case 2 -> comparator1 = new comparator.AgeComparator();
            case 3 -> {
        ...
        switch (userChoice2) {
            ...
            case 2 -> comparator2 = new comparator.AgeComparator();
            case 3 -> comparator2 = new SwimmingTimeComparator();
            case 4 -> comparator2 = new comparator.BrystsvømningComparator();
            case 5 -> comparator2 = new comparator.ButterflyComparator();
            case 6 -> comparator2 = new comparator.CrawlComparator();
